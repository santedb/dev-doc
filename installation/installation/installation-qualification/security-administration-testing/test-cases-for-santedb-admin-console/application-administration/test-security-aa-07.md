...
This is a basic test to demonstrate that the Admin Console commands operate correctly when displaying detailed information about a security application.
...
1- Use "**application.info**" command followed by the name of the application of which you wish to get the info.
...
1- Should display detailed information about the specified security application account. It's status, and effective policies.
...
Updated: 2021-07-05T02:31:20.1681960-04:00 (Administrator)
        Effective Policies:
