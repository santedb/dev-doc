...
| 303      | See Other                     | This status code is used when the caller submits data to the iCDR via a POST and the iCDR instructs the dCDR to change verbs and request data from another resource. This is common on the resolution of a VRP data code.                                                                                                     |
