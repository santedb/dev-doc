...
{% hint style="info" %}
If you're implementing an interface which mandates the use of a separate code list, it is recommended to use the [Concept Repository ](/broken/pages/-MDKigCNubPqrqqpTHds)and register your wire-level codes as reference terms.
{% endhint %}
