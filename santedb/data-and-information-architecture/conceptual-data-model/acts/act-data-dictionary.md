...
| <p>RouteConceptId<br> [0..1] ~RouteOfAdministration</p>     | UUID    | Identifies the concept that describes the route that was taken to administer the substance. This may be drawn from the default route if not supplied. |
