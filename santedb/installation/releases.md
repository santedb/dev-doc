...
The SanteDB SDK is used by developers to simulate the offline dCDR in a debug-friendly environment. The SDK is documented on the [Software Development Kit](../extending-santedb/applets/applet-sdk/) wiki page. 
