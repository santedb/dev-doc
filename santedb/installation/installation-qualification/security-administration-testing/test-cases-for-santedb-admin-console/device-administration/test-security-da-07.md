...
This is a basic test to demonstrate that the Admin Console commands operate correctly when displaying detailed information about a security device.
...
1- Use "**device.info**" command followed by the name of the device of which you wish to get the info.
...
1- Should display detailed information about the specified security device account. It's status, and effective policies.
...
Updated: 2021-06-30T22:37:32.7561230-04:00 (Administrator)
        Effective Policies:
