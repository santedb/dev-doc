...
This is a basic test to demonstrate that the Admin Console commands operate correctly when displaying detailed information about a role.
...
1- Use "**role.info**" command followed by the "**-r**" parameter followed by the name of the role of which you wish to get the info.
...
1- Should display detailed information about the specified security role. 
