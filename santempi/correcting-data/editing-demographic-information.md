...
{% hint style="info" %}
The optionality of data in the user interface depends on the national profile for minimum dataset and is enforced using the [app-settings.md](../../installation/installation/disconnected-gateway/app-settings.md "mention")
{% endhint %}
